...
digitsToBeConvertedToString = str()
numberOfDigitsToBeRead = len(digitsToBeConvertedToString)
print(numberOfDigitsToBeRead)
firstElement = digitsToBeConverted[0]
for i in range(numberOfDigitsToBeRead):
    print("")


outDictionary = {1: "jeden", 2: "dwa", 3: "trzy", 4:"cztery", 5: "pięć", 6: "sześć", 7: "siedem", 8: "osiem", 9: "dziwięć", 10: "dziesięć"}
print(outDictionary[1])




lista = []
for k in range(1, digitsToBeconverted):
    lista.append(k)
print(lista)


for y in range(digitsToBeconverted):
    print("")